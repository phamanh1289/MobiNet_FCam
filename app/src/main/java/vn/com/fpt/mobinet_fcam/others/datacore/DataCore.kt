...
object DataCore {
    ...
    fun getListConnectProperty(context: Context?): ArrayList<DetailContractKeyValueModel> {
        ...
        context?.run {
            list.run {
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_pop), key = getString(R.string.key_connect_property_pop)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_mac), key = getString(R.string.key_connect_property_vlanI)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_first), key = getString(R.string.key_connect_property_firstAccess)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_last), key = getString(R.string.key_connect_property_lastAccess)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_front), key = getString(R.string.key_connect_property_ipFront)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_route), key = getString(R.string.key_connect_property_ipRoute)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_admin), key = getString(R.string.key_connect_property_admin)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_operation), key = getString(R.string.key_connect_property_operation)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_download), value = getString(R.string.connect_property_maximum)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_upload), value = getString(R.string.connect_property_maximum)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_local_type), key = getString(R.string.key_connect_property_localType)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_mac_filter), key = getString(R.string.key_connect_property_macFilter)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_adsl), key = getString(R.string.key_connect_property_modeADSL)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_uptime), key = getString(R.string.key_connect_property_upTime)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_downstream), key = getString(R.string.key_connect_property_downStream)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_upstream), key = getString(R.string.key_connect_property_upStream)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_traffic_download), key = getString(R.string.key_connect_property_output)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_traffic_upload), key = getString(R.string.key_connect_property_input)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_snr_down), key = getString(R.string.key_connect_property_downSNR)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_snr_up), key = getString(R.string.key_connect_property_upsnr)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_attenuation_down), key = getString(R.string.key_connect_property_downAtt)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_attenuation_up), key = getString(R.string.key_connect_property_upAtt)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_rx), key = getString(R.string.key_connect_property_zxAnEponOnuRxPower)))
                add(DetailContractKeyValueModel(title = getString(R.string.title_connect_property_tx), key = getString(R.string.key_connect_property_zxAnEponOnuTxPower)))
