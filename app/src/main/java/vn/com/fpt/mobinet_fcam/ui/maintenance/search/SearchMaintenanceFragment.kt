package vn.com.fpt.mobinet_fcam.ui.maintenance.search
 ...
 * *******************************************
 */
class SearchMaintenanceFragment : BaseFragment() {
//    @Inject
//    lateinit var presenter: BlankPresenter

    companion object {
        fun newInstance(supId: String): SearchMaintenanceFragment {
            val args = Bundle()
            args.putString("", supId)
            val fragment = SearchMaintenanceFragment()
