 ...
 * *******************************************
 */
class UpdateMaintenancePresenter @Inject constructor(private val apiService: ApiService) : BasePresenter<UpdateMaintenanceContract.UpdateMaintenanceView>(), UpdateMaintenanceContract.UpdateMaintenancePresenter {
