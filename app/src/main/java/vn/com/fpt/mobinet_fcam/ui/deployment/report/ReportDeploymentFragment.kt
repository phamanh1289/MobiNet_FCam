package vn.com.fpt.mobinet_fcam.ui.deployment.report
 ...
 * *******************************************
 */
class ReportDeploymentFragment : BaseFragment() {
//    @Inject
//    lateinit var presenter: BlankPresenter

    companion object {
        fun newInstance(supId: String): ReportDeploymentFragment {
            val args = Bundle()
            args.putString("", supId)
            val fragment = ReportDeploymentFragment()
